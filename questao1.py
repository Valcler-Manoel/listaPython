...
# Tratamento de exceções consiste numa boa prática na manutenção de erros na programação,
...
# que somente aceite valores inteiros, caso coloquemos um valor do tipo ‘string’, o código normalmente iria
# quebrar logo em seguida. No entanto, com o tratamento de exceções, você pode tratar essa exceção usando
# a cláusula except ValueError: Isso permite que o programa continue a funcionar mesmo quando ocorrem er-
# ros inesperados.
...
# Agora, será demonstrado um exemplo onde haverá uma quebra no código por não haver tratamento de exceções

x = int(input('Digite um número: '))  # Caso o utilizador digite um valor diferente de um número inteiro,
