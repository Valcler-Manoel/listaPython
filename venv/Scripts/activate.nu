...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Notebook\PycharmProjects\listaDeRevisao\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Notebook\PycharmProjects\listaDeRevisao\venv\Scripts\deactivate.nu'
